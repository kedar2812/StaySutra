...
const paths = {
  ...
  beach: (
    <>
      <path d="M12.5 11.5 14 4.2" />
      <path d="M14 4.2c-2.6-.6-5 .5-6.4 2.6 2-.9 4.2-.8 6.4.6" />
      <path d="M14 4.2c2.6.5 4.4 2.4 4.8 4.9-1.4-1.7-3.2-2.6-4.8-2.6" />
      <path d="M12.5 11.5c-2.3-1.3-4.7-1-6.6.7 2.4-.1 4.6.6 6.6 1.6" />
      <path d="M2.5 19.3c1.6 0 1.6 1.4 3.2 1.4s1.6-1.4 3.2-1.4 1.6 1.4 3.2 1.4 1.6-1.4 3.2-1.4 1.6 1.4 3.2 1.4 1.6-1.4 3-1.4" />
      <path d="M12.5 11.5v4.4" />
    </>
  ),
  homestay: (
    <>
